...
public class TeacherProvider extends BaseItemProvider {
    ...
    public TeacherProvider(List<Teacher> list, AbilitySlice as) {
        this.list = list;
        this.as = as;
    }
    ...
    public Component getComponent(int i, Component component, ComponentContainer componentContainer) {
        ...
        if (component!=null){
            ...
            //获取每一个item里面的布局对象
            dl = (DirectionalLayout) LayoutScatter.getInstance(as).parse(ResourceTable.Layout_search_teacher_item, null, false);
        }
        Teacher teacher = list.get(i);
        Text text = (Text) dl.findComponentById(ResourceTable.Id_teacheritemtext);
        text.setText(teacher.getTeacherName());
