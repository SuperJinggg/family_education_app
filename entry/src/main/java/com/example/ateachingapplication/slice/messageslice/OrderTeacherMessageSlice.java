...
public class OrderTeacherMessageSlice extends AbilitySlice implements Component.ClickedListener {
    private Image back;
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_mes_order_teach);
        parent = intent.getSerializableParam("my");
        back = (Image) findComponentById(ResourceTable.Id_order_teach_back_arrow);
        ListContainer listContainer_ = (ListContainer) findComponentById(ResourceTable.Id_order_teach_list);
        ...
        ZZRHttp.postJson(url, json, new ZZRCallBack.CallBackString() {
            ...
            public void onFailure(int i, String s) {
                new ToastDialog(OrderTeacherMessageSlice.this)
                        .setText("网络不稳定")
                        .show();
            }
            @Override
            public void onResponse(String s) {
                ...
                if (result.getCode() == 200) {
                    ...
                    ReserveProvider reserveProvider = new ReserveProvider(list, OrderTeacherMessageSlice.this);
